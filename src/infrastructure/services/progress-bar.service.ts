...
export class ProgressBarService implements IProgressBarService {
  async generateCalorieProgressBar(currentCalories: number, goalCalories: number): Promise<Buffer> {
    try {
      ...
      ctx.font = `bold ${PROGRESS_BAR.TITLE_FONT_SIZE}px Arial, sans-serif`;
      ...
      ctx.font = `bold ${PROGRESS_BAR.VALUE_FONT_SIZE}px Arial, sans-serif`;
      ctx.textAlign = "left";
      ctx.textBaseline = "top";
      ...
      ctx.font = `${PROGRESS_BAR.LABEL_FONT_SIZE}px Arial, sans-serif`;
      ctx.textBaseline = "top";
      ...
      ctx.font = `bold ${PROGRESS_BAR.PERCENTAGE_FONT_SIZE}px Arial, sans-serif`;
      ctx.textAlign = "center";
